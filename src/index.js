...
const joinBtnHost = document.getElementById("join-btn-host");
...
// Joining the room
joinBtnHost.addEventListener("click", () => {
    hmsActions.join({
        userName: document.getElementById("name").value,
        authToken: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..fRWSLb8zKYH3VZG8hNp9pRvuxtK5-J3MrXvWW8hhjeg"
    });
});
...
joinBtnGuest.addEventListener("click", () => {
    hmsActions.join({
        userName: document.getElementById("name").value,
        authToken: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NfjvUMh5d9RZUFqis6UirJvkaAmKgU768E_wg8zgo_c"
    });
});
